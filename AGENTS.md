...
Rankings, higher = better. Cost reflects what I actually pay (OpenAI has generous limits), not list price. Intelligence is how hard a problem you can hand the model unsupervised. Coding is sheer coding capability. UI taste covers UI/UX, visual design, API ergonomics, and copy.
