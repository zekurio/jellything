  ...
  try {
    ...
    if (
      ...
      const [existingUser] = await db
        ...
        .where(
          and(
            eq(users.email, requestedEmail),
            ne(users.userId, session.userId),
          ),
        )
    ...
    return error(ErrorCode.OPERATION_FAILED, "Failed to update account")
  }
}
...
export async function changeMyPassword(
  ...
  try {
    ...
    return error(ErrorCode.OPERATION_FAILED, "Failed to change password")
  }
}
...
export async function uploadMyAvatar(
  ...
  try {
    ...
    return error(ErrorCode.OPERATION_FAILED, "Failed to upload avatar")
  }
}
...
export async function removeMyAvatar(
  ...
  try {
    ...
    return error(ErrorCode.OPERATION_FAILED, "Failed to remove avatar")
  }
}
...
export async function getMyExpiry(
  ...
  try {
    ...
    return error(ErrorCode.OPERATION_FAILED, "Failed to load account expiry")
  }
}
...
export async function renewMyAccess(
  ...
  try {
    ...
    return error(ErrorCode.OPERATION_FAILED, "Failed to renew access")
  }
}
...
export async function deleteMyAccount(
  ...
  try {
    ...
    return error(ErrorCode.OPERATION_FAILED, "Failed to delete account")
  }
}
