...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 sm:flex-row sm:justify-end max-sm:sticky max-sm:bottom-0 max-sm:z-10 max-sm:-mx-5 max-sm:border-t max-sm:bg-background max-sm:px-5 max-sm:pt-3 max-sm:pb-[calc(1.25rem+env(safe-area-inset-bottom))]",
        className,
      )}
      {...props}
    />
